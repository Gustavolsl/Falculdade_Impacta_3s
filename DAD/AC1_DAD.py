...
Aviso: "Exercicio dicionarios"
Lucas Mendes Marques Gonçalves
Criado em: 11:1511:15
Exercicio dicionarios

dicionarios.py
Texto

Aviso: "formulario para a atividade"
Lucas Mendes Marques Gonçalves
Criado em: 10:1010:10
formulario para a atividade

exemplinho.py
Formulários Google

Aviso: "Apresentacao da disciplina e planos de…"
Lucas Mendes Marques Gonçalves
Criado em: 08:1608:16
Apresentacao da disciplina e planos de aula

DAD - A01 - Apresentação da Disciplina - Lucas.pptx
PowerPoint

2s2019SI-3A-M - Desenvolvimento de Aplicações Distribuídas - LUCAS MENDES MARQUES GONÇALVES.docx
Word

2s2019ADS-3A-M - Desenvolvimento de Aplicações Distribuídas - LUCAS MENDES MARQUES GONÇALVES.docx
Word

Aviso: "Caros, para ter acesso aos videos da…"
Lucas Mendes Marques Gonçalves
Criado em: 18 de ago18 de ago
Caros, para ter acesso aos videos da disciplina, as notas de ACs (quando existirem) e a outros conteudos, basta acessar a descrição da disciplina. Veja imagem em anexo!

banner_da_disciplina.png
Imagem

Aviso: "O video de hoje infelizmente nao salvou…"
Lucas Mendes Marques Gonçalves
Criado em: 13 de ago13 de ago
O video de hoje infelizmente nao salvou por problemas técnicos. Mas se você olhar no banner da disciplina (o desenho da mochila) tem um v (uma seta pra baixo) onde temos o link para todos os videos. Vou postar tudo lá.

Aviso: "Escreva sua função no arquivo mesmo No…"
Lucas Mendes Marques Gonçalves
Criado em: 13 de ago13 de ago
Escreva sua função no arquivo mesmo

No IDLE (ide do python) é so apertar F5 para carregar o arquivo e digitar runTests() para rodar os testes

Aviso: "arquivo de teste do contador"
Lucas Mendes Marques Gonçalves
Criado em: 13 de ago13 de ago
arquivo de teste do contador
