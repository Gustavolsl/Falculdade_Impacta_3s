...
class TestStringMethods(unittest.TestCase):
    ...
    def test_500_ofertadas_retorna_lista(self):
        r_reset = requests.post('http://localhost:5004/reseta')
        r = requests.get('http://localhost:5004/ofertadas')
        self.assertEqual(type(r.json()),type([]))
        self.assertEqual(len(r.json()),0)
    
    def test_500b_nao_confundir_ofertada_e_outras_entidades(self):
        r_reset = requests.post('http://localhost:5004/reseta')
        r_reset = requests.post('http://localhost:5002/reseta')
        r_reset = requests.post('http://localhost:5003/reseta')
        r = requests.post('http://localhost:5002/alunos',json={'nome':'fernando','id':1})
        ...
        r = requests.post('http://localhost:5003/disciplinas',json={'id':100,'nome':'estruturas de dados','status':12,'plano_ensino':'dados','carga_horaria':15})
        self.assertEqual(r.status_code,200)
        r_lista = requests.get('http://localhost:5004/ofertadas')
        self.assertEqual(len(r_lista.json()),0)

    def test_501_adiciona_ofertadas(self):
        r = requests.post('http://localhost:5004/ofertadas',json={'id':100,'ano':2019,'semestre':1,'turma':'SI3','data':'2019-04-13'})
        r = requests.post('http://localhost:5004/ofertadas',json={'id':101,'ano':2019,'semestre':1,'turma':'ADS3','data':'2019-04-13'})
        r_lista = requests.get('http://localhost:5004/ofertadas')
        achei_ads = False
        achei_si = False
    ...
    def test_502_disciplinas_por_id(self):
        r = requests.post('http://localhost:5004/ofertadas',json={'id':110,'ano':2010,'semestre':1,'turma':'ADS2','data':'2010-04-20'})
        r_lista = requests.get('http://localhost:5004/ofertadas/110')
    ...
    def test_503_adiciona_e_reseta(self):
        r = requests.post('http://localhost:5004/ofertadas',json={'id':110,'ano':2010,'semestre':2,'turma':'GTI2','data':'2010-04-20'})
        r_lista = requests.get('http://localhost:5004/ofertadas')
        self.assertTrue(len(r_lista.json()) > 0)
        r_reset = requests.post('http://localhost:5004/reseta')
        self.assertEqual(r_reset.status_code,200)
        r_lista_depois = requests.get('http://localhost:5004/ofertadas')
        self.assertEqual(len(r_lista_depois.json()),0)

    def test_504_adiciona_e_deleta(self):
        r_reset = requests.post('http://localhost:5004/reseta')
        self.assertEqual(r_reset.status_code,200)
        r = requests.post('http://localhost:5004/ofertadas',json={'id':100,'ano':2019,'semestre':1,'turma':'SI3','data':'2019-04-13'})
        r = requests.post('http://localhost:5004/ofertadas',json={'id':1,'ano':2019,'semestre':1,'turma':'ADS3','data':'2019-11-13'})
        r_lista = requests.get('http://localhost:5004/ofertadas')
        self.assertEqual(len(r_lista.json()),2)
        requests.delete('http://localhost:5004/ofertadas/100')
        r_lista = requests.get('http://localhost:5004/ofertadas')
        self.assertEqual(len(r_lista.json()),1)
    
    def test_505_edita(self):
        r_reset = requests.post('http://localhost:5004/reseta')
        self.assertEqual(r_reset.status_code,200)
        r = requests.post('http://localhost:5004/ofertadas',json={'id':1,'ano':2019,'semestre':1,'turma':'ADS3','data':'2019-11-13'})
        r_antes = requests.get('http://localhost:5004/ofertadas/1')
        self.assertEqual(r_antes.json()['turma'],'ADS3')
        requests.put('http://localhost:5004/ofertadas/1',json={'id':1,'ano':2019,'semestre':1,'turma':'ADS2','data':'2019-11-13'})
        #o que mudou foi a turma
        r_depois = requests.get('http://localhost:5004/ofertadas/1')
        self.assertEqual(r_depois.json()['turma'],'ADS2')

    def test_506_id_inexistente(self):
        r_reset = requests.post('http://localhost:5004/reseta')
        self.assertEqual(r_reset.status_code,200)
        r = requests.put('http://localhost:5004/ofertadas/10',json={'id':10,'ano':2020,'semestre':2,'turma':'SI2','data':'2019-10-13'})
        self.assertIn(r.status_code,[400,404])
        self.assertEqual(r.json()['erro'],'ofertada nao encontrada')
        r = requests.get('http://localhost:5004/ofertadas/15')
        self.assertIn(r.status_code,[400,404])
        self.assertEqual(r.json()['erro'],'ofertada nao encontrada')
        r = requests.delete('http://localhost:5004/ofertadas/15')
        self.assertIn(r.status_code,[400,404])
        self.assertEqual(r.json()['erro'],'ofertada nao encontrada')

    def test_507_criar_com_id_ja_existente(self):
        r_reset = requests.post('http://localhost:5004/reseta')
        self.assertEqual(r_reset.status_code,200)
        r = requests.post('http://localhost:5004/ofertadas',json={'id':100,'ano':2019,'semestre':1,'turma':'SI3','data':'2019-04-13'})
        self.assertEqual(r.status_code,200)
        r = requests.post('http://localhost:5004/ofertadas',json={'id':100,'ano':2011,'semestre':1,'turma':'ADS3','data':'2011-11-23'})
        self.assertIn(r.status_code,[400,409])
        self.assertEqual(r.json()['erro'],'id ja utilizada')

    def test_508_post_com_campos_faltando(self):
        r_reset = requests.post('http://localhost:5004/reseta')
        self.assertEqual(r_reset.status_code,200)
        r = requests.post('http://localhost:5004/ofertadas',json={'id':100,'ano':2019,'semestre':1,'turma':'SI3','data':'2019-04-13'})
        self.assertEqual(r.status_code,200)
        r = requests.post('http://localhost:5004/ofertadas',json={         'ano':2019,'semestre':1,'turma':'SI3','data':'2019-04-13'})
        self.assertIn(r.status_code,[400,422])
        self.assertTrue('erro' in r.json())
        r = requests.post('http://localhost:5004/ofertadas',json={'id':101,           'semestre':1,'turma':'SI3','data':'2019-04-13'})
        self.assertIn(r.status_code,[400,422])
        self.assertTrue('erro' in r.json())
        r = requests.post('http://localhost:5004/ofertadas',json={'id':102,'ano':2019,             'turma':'SI3','data':'2019-04-13'})
        self.assertIn(r.status_code,[400,422])
        self.assertTrue('erro' in r.json())
        r = requests.post('http://localhost:5004/ofertadas',json={'id':103,'ano':2019,'semestre':1,'turma':'SI3'                    })
        self.assertIn(r.status_code,[400,422])
        self.assertTrue('erro' in r.json())
        
        
    def test_509_professor_deve_ser_valido_ao_criar_ofertada(self):
        r_reset = requests.post('http://localhost:5004/reseta')
        r_reset = requests.post('http://localhost:5002/reseta')
        self.assertEqual(r_reset.status_code,200)
        r = requests.post('http://localhost:5004/ofertadas',json={'id':100,'ano':2019,'semestre':1,'turma':'SI3','data':'2019-04-13','id_professor':5000})
        self.assertIn(r.status_code,[400,422])
        r_lista = requests.get('http://localhost:5004/ofertadas')
        self.assertTrue(len(r_lista.json()) == 0)
        requests.post('http://localhost:5002/professores',json={'nome':'lucas','id':5000})
        r = requests.post('http://localhost:5004/ofertadas',json={'id':100,'ano':2019,'semestre':1,'turma':'SI3','data':'2019-04-13','id_professor':5000})
        self.assertEqual(r.status_code,200)
        r_lista = requests.get('http://localhost:5004/ofertadas')
        self.assertTrue(len(r_lista.json()) == 1)
        ofertada = r_lista.json()[0]
        self.assertEqual(ofertada['id_professor'],5000)
    
    def test_510_disciplina_deve_ser_valida_ao_criar_ofertada(self):
        r_reset = requests.post('http://localhost:5004/reseta')
        r_reset = requests.post('http://localhost:5003/reseta')
        self.assertEqual(r_reset.status_code,200)
        r = requests.post('http://localhost:5004/ofertadas',json={'id':100,'ano':2019,'semestre':1,'turma':'SI3','data':'2019-04-13','id_disciplina':250})
        self.assertIn(r.status_code,[400,422])
        r_lista = requests.get('http://localhost:5004/ofertadas')
        self.assertTrue(len(r_lista.json()) == 0)
        r = requests.post('http://localhost:5003/disciplinas',json={'id':250,'nome':'distribuidos','status':12,'plano_ensino':'clientes e servidores','carga_horaria':10})
        self.assertEqual(r.status_code,200)
        r = requests.post('http://localhost:5004/ofertadas',json={'id':100,'ano':2019,'semestre':1,'turma':'SI3','data':'2019-04-13','id_disciplina':250})
        r_lista = requests.get('http://localhost:5004/ofertadas')
        self.assertTrue(len(r_lista.json()) == 1)
